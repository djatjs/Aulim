...
export default function RadialOrbitalTimeline({
    ...
    return (
        <div
            className="w-full h-[600px] flex flex-col items-center justify-center bg-black/40 backdrop-blur-sm overflow-hidden rounded-[3rem] border border-white/5 relative"
            ref={containerRef}
